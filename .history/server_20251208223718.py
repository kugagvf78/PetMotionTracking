...
PET_MODEL = YOLO("yolov8n.pt")   # có thể đổi sang yolov8s.pt nếu muốn độ chính xác cao hơn
PET_THRESHOLD = 0.25
...
def camera_loop():
    ...
    global camera   # 🔥 SỬA LỖI camera scope

    error_count = 0

    while True:
        try:
            # Nếu camera bị mất hoặc chưa mở → thử mở lại
            ...
            # Motion ảnh hưởng đến behavior_score
            if motion_detected:
                log_motion()
...
# ==================================================
# SENSOR STATUS API (Dashboard cần dữ liệu này)
# ==================================================
