...
PET_MODEL = YOLO("runs/detect/train/weights/best.pt")
PET_THRESHOLD = 0.03   # conf thấp để detect pet yếu
...
def camera_loop():
    ...
    while True:
        try:
            ...
            # ================================
            # YOLO PET DETECTION — FIXED
            # ================================
            pet_label = "Không thấy"
            pet_conf = 0.00

            try:
                # chạy predict như test_yolo (conf thấp)
                ...
                for r in results:
                    for box in r.boxes:
                        ...
                        # Debug → xem YOLO đang detect gì
                        print("YOLO DETECT:", label, conf)

                        # detect nếu conf >= 0.03
