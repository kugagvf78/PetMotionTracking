...
PET_MODEL = YOLO("yolov8n.pt")   # đổi sang yolov8s.pt nếu muốn độ chính xác cao hơn
PET_THRESHOLD = 0.25

# ==================================================
# GLOBAL SENSOR STATES
# ==================================================
last_pir = 0          # PIR từ ESP8266 (hiện là default)
last_rfid = None      # RFID từ ESP8266 (default)
...
def camera_loop():
    ...
    global camera   # 🔥 FIX quan trọng để không lỗi scope

    error_count = 0

    while True:
        try:
            # Nếu camera mất tín hiệu → thử mở lại
...
# ==================================================
# SENSOR STATUS API (Dashboard cần)
# ==================================================
